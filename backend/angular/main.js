...
/* harmony import */ var _confirmation_confirmation_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confirmation/confirmation.component */ "./src/app/confirmation/confirmation.component.ts");
...
var routes = [
    ...
    { path: 'confirmation/:message', component: _confirmation_confirmation_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmationComponent"] }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _confirmation_confirmation_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmationComponent"]
            ],
            imports: [
...
var ConfirmationComponent = /** @class */ (function () {
    function ConfirmationComponent(route) {
        this.route = route;
    }
    ConfirmationComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) { return _this.message = params['message']; });
    };
...
var DonateService = /** @class */ (function () {
    ...
    DonateService.prototype.donate = function (amount) {
...
module.exports = "<input type=\"number\" placeholder=\"Enter the amount\" [(ngModel)]=\"amount\">\n\n<button class=\"btn btn-primary\" (click)=\"donate()\">Pay</button>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _donate_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../donate.service */ "./src/app/donate.service.ts");
...
var PaymentComponent = /** @class */ (function () {
    function PaymentComponent(donateService, document) {
        this.donateService = donateService;
        this.document = document;
    }
    PaymentComponent.prototype.ngOnInit = function () {
    };
    PaymentComponent.prototype.donate = function () {
        var _this = this;
        this.donateService.donate(this.amount).subscribe(function (responseData) {
            console.log(responseData);
            _this.document.location.href = responseData.message;
        }, function (error) {
            console.log(error);
        });
    };
    PaymentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_donate_service__WEBPACK_IMPORTED_MODULE_1__["DonateService"], Object])
    ], PaymentComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Acer\Desktop\Projects\PaymentGateway\paypalIntegration\src\main.ts */"./src/main.ts");
